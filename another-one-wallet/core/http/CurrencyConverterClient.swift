...
//
//  Source: https://github.com/ThiagoAM/CurrencyConverter/blob/master/CurrencyConverter.swift
...
enum Currency : String, CaseIterable {
    ...
    static func getCurrencySymbol(currency: Currency) -> String {
...
class CurrencyConverter {
    ...
    public func updateExchangeRates(completion : @escaping () -> Void = {}) {
        xmlParser.parse(completion: {
            ...
            debugPrint("CURRENCIES ARE", self.exchangeRates)
            // Runs the completion:
            completion()
            ...
            debugPrint("FAILED TO LOAD CURRENCIES RATE")
            // Runs the completion:
            completion()
        })
    }
